...
class RoleControllerTest extends TestCase
{
    ...
    public function it_displays_index_view_with_roles()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.roles.index')
            ->assertViewHas('roles');
    }
    ...
    public function it_displays_create_view_for_role()
    {
        ...
        $response->assertOk()->assertViewIs('resources.views.roles.create');
    }
    ...
    public function it_displays_show_view_for_role()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.roles.show')
            ->assertViewHas('role');
    }
    ...
    public function it_displays_edit_view_for_role()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.roles.edit')
            ->assertViewHas('role');
    }
