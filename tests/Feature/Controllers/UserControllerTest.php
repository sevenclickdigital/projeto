...
class UserControllerTest extends TestCase
{
    ...
    public function it_displays_index_view_with_users()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.users.index')
            ->assertViewHas('users');
    }
    ...
    public function it_displays_create_view_for_user()
    {
        ...
        $response->assertOk()->assertViewIs('resources.views.users.create');
    }
    ...
    public function it_displays_show_view_for_user()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.users.show')
            ->assertViewHas('user');
    }
    ...
    public function it_displays_edit_view_for_user()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.users.edit')
            ->assertViewHas('user');
    }
