...
class PermissionControllerTest extends TestCase
{
    ...
    public function it_displays_index_view_with_permissions()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.permissions.index')
    ...
    public function it_displays_create_view_for_permission()
    {
        ...
        $response->assertOk()->assertViewIs('resources.views.permissions.create');
    }
    ...
    public function it_displays_show_view_for_permission()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.permissions.show')
    ...
    public function it_displays_edit_view_for_permission()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('resources.views.permissions.edit')
            ->assertViewHas('permission');
    }
